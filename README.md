...
- **WiFi setup система** - красивый интерфейс настройки WiFi
...
5. Настройте WiFi через красивый интерфейс настройки
6. Начните использовать паяльную станцию!

## ⚠️ Важные замечания

- **GitHub токен**: Для автоматического обновления нужно настроить токен в прошивке
- **Библиотеки**: Установите все необходимые библиотеки перед компиляцией
- **Тестирование**: Прошивка требует тестирования на реальном оборудовании

См. `KNOWN_ISSUES.md` для подробной информации о известных проблемах.
